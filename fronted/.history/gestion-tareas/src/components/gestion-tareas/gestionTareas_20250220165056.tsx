...
import { GestionTareasService, TareasResponse , SummaryService } from 'services/gestionTareasService';
...
export default function GestionTareas() {
  ...
  */
  ...
  const agregarTarea = async (e: React.FormEvent) => {
    ...
    try {
      const tareaRequest: Tarea = {
        ...
        idUsuario: formData.usuarioAsignado,
  ...
  const handleAddTask = () => {
    ...
    console.log('Iniciando proceso de agregar tarea');
  };
