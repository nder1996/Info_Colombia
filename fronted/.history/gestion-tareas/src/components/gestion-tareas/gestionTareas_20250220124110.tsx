...
export default function GestionTareas() {
  ...
  const buttonEditar = () => {
    return <Button label="Editar" className="p-button-sm" />;
  };

  const buttonEliminar = () => {
    return <Button label="Eliminar" className="p-button-sm" />;
  };
  ...
  return (
    <div className="card" style={{
      ...
      <Column body={buttonTemplate} header="Acción" style={{ width: '10%' }}></Column>
      </DataTable>
    </div>
  );
}
