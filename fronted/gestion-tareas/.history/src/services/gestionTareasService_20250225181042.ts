...
export class GestionTareasService {
    ...
    static async inactivarTarea(id?: number): Promise<ApiResponse<string>> {
        try {
            ...
            return {
                meta: { message: "Error", statusCode: 500 },
                error: {
                    code: "ERROR_DELETE_TAREA",
                    description: "Error al eliminar un registro"
                }
            };
        }
    }
