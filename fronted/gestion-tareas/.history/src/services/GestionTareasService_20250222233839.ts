...
export class GestionTareasService {
    private static readonly api = InterceptorAuth.otros; // Usa la instancia con los interceptores
    ...
    static async getTareasXUsuario(username: string): Promise<ApiResponse<TareasResponse[]>> {
        try {
