...
export default function GestionTareas() {
  ...
  optionLabel="nombre" // Muestra el nombre en la UI
  optionValue="id" // Guarda el id en el formulario
  {...register("estado")}
  onChange={(e) => setValue("estado", Number(e.target.value))} // Convierte a número
/>
