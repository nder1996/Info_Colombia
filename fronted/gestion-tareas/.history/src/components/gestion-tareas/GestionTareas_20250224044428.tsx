        ...
        <form onSubmit={handleSubmit(eventoSelectAccion)} className="form-container">
          ...
          <div className="form-group">
            ...
            <Calendar
              id="fechaVencimiento"
              dateFormat="dd/mm/yy"
              value={watch('fechaVencimiento') ?? null} // Asegura que el valor sea null si es undefined
              minDate={new Date()}
              onChange={(e) => {
                const newValue = e.value || null; // Asegura que el valor sea null si es undefined
