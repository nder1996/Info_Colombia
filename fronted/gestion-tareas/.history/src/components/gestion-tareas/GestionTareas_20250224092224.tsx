  ...
  return (
    <div className="card" style={{
      ...
      <DataTable
        ...
        scrollable
        scrollHeight="400px"
        emptyMessage={t.tareas.sinTareas}
        size={'small'}
        showGridlines
        stripedRows
      ...
      >
        <Column
          filter
          field="id"
          header={t.tareas.tabla.numTarea}
          filterPlaceholder={t.tareas.tabla.buscarPorId}
          style={{ width: '5%', textAlign: 'center' }}
        />
        <Column filter field={t.tareas.titulo}  header="Título" filterPlaceholder={t.tareas.tabla.buscarPorTitulo} style={{ width: '20%' }}></Column>
