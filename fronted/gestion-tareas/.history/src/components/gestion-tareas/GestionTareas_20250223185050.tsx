    ...
    <div className="card" style={{
      ...
      >
        <Column className="text-center"
          headerClassName="text-center" filter field="id" header="ID" filterPlaceholder="Buscar por ID" style={{ width: '5%' }}></Column>
        ...
        <Column
          ...
          headerStyle={{ textAlign: 'center' }}
        ></Column>
        <Column filter body={buttonEditar} header="Acción" style={{ width: '10%' }}
          headerStyle={{ textAlign: 'center' }}></Column>
        <Column filter body={buttonEliminar} header="Acción" style={{ width: '10%' }}
          headerStyle={{ textAlign: 'center' }}></Column>
      </DataTable>
      <Dialog
        header="Nueva Tarea"
