  ...
  return (
    <div className="card" style={{
      ...
      <DataTable
        ...
        filterDisplay="menu"
      >
        <Column field="id" header="ID" filter filterPlaceholder="Buscar por ID" style={{ width: '5%' }}></Column>
        <Column field="titulo" header="Título" filter filterPlaceholder="Buscar por título" style={{ width: '20%' }}></Column>
        <Column field="descripcion" header="Descripción" filter filterPlaceholder="Buscar por descripción" style={{ width: '25%' }}></Column>
        <Column
