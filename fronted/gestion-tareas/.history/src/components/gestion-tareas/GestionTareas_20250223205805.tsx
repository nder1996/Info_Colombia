        ...
        <form onSubmit={handleSubmit(eventoSelectAccion)} className="form-container">
          ...
          <div className="form-group">
            ...
            <Calendar
              ...
              No se puede asignar un argumento de tipo "Nullable<Date>" al parámetro de tipo "Date".
  El tipo 'undefined' no se puede asignar al tipo 'Date'.ts(2345)
(property) FormEvent<Date, SyntheticEvent<Element, Event>>.target: FormTarget<Date>
            />
