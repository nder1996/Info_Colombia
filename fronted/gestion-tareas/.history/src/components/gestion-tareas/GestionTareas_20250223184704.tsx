    ...
    <div className="card" style={{
      ...
      >
        ...
        <Column
          ...
          filter
          style={{ width: '15%' }}
          alignHeader="center"  // Centra el encabezado
        ...
        <Column
          ...
          style={{ width: '10%' }}
        ></Column>
        <Column filter body={buttonEditar} header="Acción" style={{ width: '10%' }}></Column>
        <Column filter body={buttonEliminar} header="Acción" style={{ width: '10%' }}></Column>
      </DataTable>
      <Dialog
        header="Nueva Tarea"
        visible={visible}
