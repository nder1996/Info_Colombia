  ...
  return (
    <div className="card" style={{
      ...
      >
        ...
        />
        <Column filter field={texts.titulo} header="Título" filterPlaceholder={texts.tabla.buscarPorTitulo} style={{ width: '20%' }}>
        </Column>        
        <Column filter field={texts.descripcion} header="Descripción" filterPlaceholder={texts.tabla.buscarPorDescripcion} style={{ width: '25%' }}></Column>        <Column
