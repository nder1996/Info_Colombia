...
export default function GestionTareas() {
  const { control, register, handleSubmit, setValue, formState: { errors }, reset, watch , resolver} = useForm<dataTarea>({
  ...
  useEffect(() => {
    fetchTareas();
    fetchRoles();
    // Puedes llamar a loadUsuario() si lo necesitas
  ...
  return (
    <div className="card" style={{
      ...
      >
        ...
        />
        <Column filter field="titulo" header="Título" filterPlaceholder="Buscar por título" style={{ width: '20%' }} />
        <Column filter field="descripcion" header="Descripción" filterPlaceholder="Buscar por descripción" style={{ width: '25%' }} />
        <Column
          ...
          {rolAdmin === true && (
            <div className="form-group">
              ...
              <Dropdown
                ...
                onChange={(e) => setValue('usuarioAsignado', e.value)}
              />
