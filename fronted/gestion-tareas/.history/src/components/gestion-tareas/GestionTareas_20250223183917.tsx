...
export default function GestionTareas() {
  ...
  const [selectedItems, setSelectedItems] = useState<TareasResponseLocal[]>([]);
  ...
  */
  ...
  return (
    <div className="card" style={{
      ...
      >
        <Column filter  field="id" header="ID"  filterPlaceholder="Buscar por ID" style={{ width: '5%' }}></Column>
        <Column field="titulo" header="Título"  filterPlaceholder="Buscar por título" style={{ width: '20%' }}></Column>
        <Column field="descripcion" header="Descripción"  filterPlaceholder="Buscar por descripción" style={{ width: '25%' }}></Column>
        <Column
