...
const createValidationSchema = (t: typeof traducciones) => yup.object({
  username: yup
    .string()
    .required(t.authentication.emailRequerido)
    .email(t.authentication.emailValido),
  password: yup
    .string()
    .required(t.authentication.contrasenaRequerida)
});
