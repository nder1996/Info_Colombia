...
const InicioSession = () => {
    ...
    try {
      ...
      if (!token || token.trim() === "") {
        ...
        toastRef.current?.show({
          ...
          detail: 'Verifique su email y contraseña',
          life: 3000
        });
        return;
      }
      ...
      toastRef.current?.show({
        severity: 'warn',
        summary: 'Authenticación fallida',
        detail: error.response?.status != 200
  ...
  return (
    <div className="login-container">
      ...
      <a 
        className="text-blue-500 hover:text-blue-700 cursor-pointer flex items-center gap-2 text-sm font-medium no-underline hover:underline transition-colors duration-200"
