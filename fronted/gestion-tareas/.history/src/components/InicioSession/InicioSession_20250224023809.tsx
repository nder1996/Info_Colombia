...
export const createValidationSchema = (translations: Record<Language, ITranslations>, language: Language) => yup.object({
  username: yup
    .string()
    .required(translations[language].authentication.emailRequerido)
    .email(translations[language].authentication.emailValido),
  password: yup
    .string()
    .required(translations[language].authentication.contrasenaRequerida)
});
